...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-600 to-primary-900 flex items-center justify-center px-3 sm:px-6 py-4 sm:py-6">
      <div className="w-full max-w-[340px] sm:max-w-md">
        <div className="bg-white rounded-lg sm:rounded-2xl shadow-2xl p-5 sm:p-8">
          <div className="text-center mb-4 sm:mb-8">
            ...
            <div className="mb-2 sm:mb-4">
              ...
              />
              <h1 className="text-xl sm:text-3xl font-bold text-gray-900 mb-2" style={{display: 'none'}}>
                MR PIKIPIKI TRADING
              </h1>
            </div>
            <h2 className="text-lg sm:text-2xl font-bold text-gray-900 mb-0.5 sm:mb-2">MR PIKIPIKI TRADING</h2>
          ...
          <div className="mt-3 sm:mt-6 text-center text-xs sm:text-sm text-gray-600">
