...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-600 to-primary-900 flex items-center justify-center px-4 sm:px-6 py-6">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl p-6 sm:p-8">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-gray-900 mb-1 sm:mb-2">MR PIKIPIKI TRADING</h2>
