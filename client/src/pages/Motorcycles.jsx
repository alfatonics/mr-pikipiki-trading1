...
const Motorcycles = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...formData,
        supplierId: formData.supplier || null, // Rename supplier to supplierId
      };
      delete payload.supplier; // Remove old field name

      if (editingMotorcycle) {
        await axios.put(`/api/motorcycles/${editingMotorcycle._id}`, payload);
      } else {
